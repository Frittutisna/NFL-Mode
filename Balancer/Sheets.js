...
function balanceTeams() {
    ...
    let msg = `Success (NFL Mode): ${numSelected} players into ${numTeams} teams`;
...
function resetPlayers()     {SpreadsheetApp.getActiveSpreadsheet().getActiveSheet().getRange(ADDR_PLAYERS)  .clearContent();}
function resetTeams()       {SpreadsheetApp.getActiveSpreadsheet().getActiveSheet().getRange(ADDR_OUTPUT)   .clearContent();}
function resetRequests()    {SpreadsheetApp.getActiveSpreadsheet().getActiveSheet().getRange(ADDR_REQS)     .clearContent();}
function resetBlacklists()  {SpreadsheetApp.getActiveSpreadsheet().getActiveSheet().getRange(ADDR_BL)       .clearContent();}